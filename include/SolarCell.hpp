...
namespace SOLARCELL
{
	...
	*/
	...
	inline	double grain_boundary_Recombination(const double & electron_density,
					 const double & hole_density,
					 const ParameterSpace::Parameters & params)
	{
		return  (params.scaled_intrinsic_density *
				 ...
				 electron_density * hole_density)
				 /
				 ( params.scaled_hole_recombo_t_gb *
				  (electron_density + params.scaled_srh_electron_density_gb)
				  +
				   params.scaled_electron_recombo_t_gb *
				  (hole_density     + params.scaled_srh_hole_density_gb    )
				 );

	}


	inline	double grain_boundary_occupancy(const double & electron_density,
					 const double & hole_density,
					 const ParameterSpace::Parameters & params)
	{
		return  (params.scaled_hole_recombo_t_gb * electron_density +
				 params.scaled_electron_recombo_t_gb * params.scaled_srh_hole_density_gb)
				 /
				 ( params.scaled_hole_recombo_t_gb *
				  (electron_density + params.scaled_srh_electron_density_gb)
				  +
